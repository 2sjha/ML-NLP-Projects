...
class RandomForestClsfr:
    ...
    def train(self, dataset):
        ...
        self.classifier = RandomForestClassifier(random_state=0, n_jobs=-1)
    ...
    def tune_parameters(self, dataset, compute_f1=True):
        ...
        classifiers = [
            # change ecriterion
            RandomForestClassifier(random_state=0, criterion="entropy", n_jobs=-1),
            RandomForestClassifier(random_state=0, criterion="log_loss", n_jobs=-1),
            # change min_samples_split
            RandomForestClassifier(
                random_state=0, criterion="entropy", min_samples_split=5, n_jobs=-1
            ),
            RandomForestClassifier(
                random_state=0, criterion="log_loss", min_samples_split=5, n_jobs=-1
            ),
            RandomForestClassifier(
                random_state=0, criterion="entropy", min_samples_split=10, n_jobs=-1
            ),
            RandomForestClassifier(
                random_state=0, criterion="log_loss", min_samples_split=10, n_jobs=-1
            ),
